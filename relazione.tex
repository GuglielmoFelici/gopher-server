...
e due binari aggiuntivi posizionati in src/helpers nel caso in cui si buildi su Windows.\\
E' possibile eseguire il programma con le seguenti opzioni:\\
\\-h\\ \hspace*{2cm} Mostra la sintassi\\
-s\\ \hspace*{2cm} (silent) - Non loggare in console/syslog\\
-p PORT \\ \hspace*{2cm} Metti il server in ascolto sulla porta PORT\\
-d DIR \\ \hspace*{2cm} Utilizza la directory DIR come root del server\\
-m \\ \hspace*{2cm} Utilizza il server in modalità multiprocesso\\

Il programma legge le 
