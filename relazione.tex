...
-p PORT
    ...
    Default: 7070.
-v
    Imposta il livello di verbosità del server, (syslog su Linux, console su Windows). Può essere
    0 - Non loggare nulla.
    1 - Logga gli errori.
    2 - Logga gli errori e i warning.
    3 - Logga gli errori, i warning e i messaggi di info.
    4 - Logga gli errori, i warning, i messaggi di info e i messaggi di debug.
    Default: 2.
