...
Il modulo di Compatibilità offre numerose funzionalità implementate in modo portabile per essere riutilizzate
...
Vengono creati i due oggetti server_t e logger_t per gestire rispettivamente server e logger.
Dopo aver letto e settato opportunamente le configurazioni nella struttura server_t, viene eseguita la 
